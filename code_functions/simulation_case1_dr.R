...
simulation <- function(l, n, d, err, base, base.test, x.test, eps.test, opt.q.25, opt.q.50) {
  ...
  formula <- as.formula("y ~ x.2 + a + I(a * x.2)")
  xa <- model.matrix(formula, dataframe)[, -1]
  ...
  v.SCL.linear.25.correctcorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.25.correctcorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.25.correctcorrect + 1) * eps.test, 0.25)
  v.SCL.linear.50.correctcorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.50.correctcorrect * (x.test[, 2] + x.test[, 3]) + ( 2*treat.SCL.linear.50.correctcorrect + 1) * eps.test, 0.50)
  v.SCL.gaussian.25.correctcorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.25.correctcorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.25.correctcorrect + 1) * eps.test, 0.25)
  v.SCL.gaussian.50.correctcorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.50.correctcorrect * (x.test[, 2] + x.test[, 3]) + ( 2*treat.SCL.gaussian.50.correctcorrect + 1) * eps.test, 0.50)

  v.SCL.linear.25.incorrect1correct <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.25.incorrect1correct * (x.test[, 2] + x.test[, 3]) + ( 2*treat.SCL.linear.25.incorrect1correct + 1) * eps.test, 0.25)
  v.SCL.gaussian.25.incorrect1correct <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.25.incorrect1correct * (x.test[, 2] + x.test[, 3]) + ( 2*treat.SCL.gaussian.25.incorrect1correct + 1) * eps.test, 0.25)
  v.SCL.linear.50.incorrect1correct <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.50.incorrect1correct * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.50.incorrect1correct + 1) * eps.test, 0.50)
  v.SCL.gaussian.50.incorrect1correct <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.50.incorrect1correct * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.50.incorrect1correct + 1) * eps.test, 0.50)

  v.SCL.linear.25.incorrect2correct <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.25.incorrect2correct * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.25.incorrect2correct + 1) * eps.test, 0.25)
  v.SCL.gaussian.25.incorrect2correct <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.25.incorrect2correct * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.25.incorrect2correct + 1) * eps.test, 0.25)
  v.SCL.linear.50.incorrect2correct <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.50.incorrect2correct * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.50.incorrect2correct + 1) * eps.test, 0.50)
  v.SCL.gaussian.50.incorrect2correct <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.50.incorrect2correct * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.50.incorrect2correct + 1) * eps.test, 0.50)

  v.SCL.linear.25.correctincorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.25.correctincorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.25.correctincorrect + 1) * eps.test, 0.25)
  v.SCL.gaussian.25.correctincorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.25.correctincorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.25.correctincorrect + 1) * eps.test, 0.25)
  v.SCL.linear.50.correctincorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.50.correctincorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.50.correctincorrect + 1) * eps.test, 0.50)
  v.SCL.gaussian.50.correctincorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.50.correctincorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.50.correctincorrect + 1) * eps.test, 0.50)

  v.SCL.linear.25.incorrect1incorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.25.incorrect1incorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.25.incorrect1incorrect + 1) * eps.test, 0.25)
  v.SCL.gaussian.25.incorrect1incorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.25.incorrect1incorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.25.incorrect1incorrect + 1) * eps.test, 0.25)
  v.SCL.linear.50.incorrect1incorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.50.incorrect1incorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.50.incorrect1incorrect + 1) * eps.test, 0.50)
  v.SCL.gaussian.50.incorrect1incorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.50.incorrect1incorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.50.incorrect1incorrect + 1) * eps.test, 0.50)

  v.SCL.linear.25.incorrect2incorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.25.incorrect2incorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.25.incorrect2incorrect + 1) * eps.test, 0.25)
  v.SCL.gaussian.25.incorrect2incorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.25.incorrect2incorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.25.incorrect2incorrect + 1) * eps.test, 0.25)
  v.SCL.linear.50.incorrect2incorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.linear.50.incorrect2incorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.linear.50.incorrect2incorrect + 1) * eps.test, 0.50)
  v.SCL.gaussian.50.incorrect2incorrect <- quantile(eval(parse(text = base.test)) + treat.SCL.gaussian.50.incorrect2incorrect * (x.test[, 2] + x.test[, 3]) + (2* treat.SCL.gaussian.50.incorrect2incorrect + 1) * eps.test, 0.50)
...
# parallel computing
system.time({
  res <- parLapply(cl, 1:times, simulation, n = n, d=d, err = case1.err, base = case1.base, base.test = case1.base.test, x.test = x, eps.test = eps, opt.q.25 = case1.opt.q.25, opt.q.50 = case1.opt.q.50)
})
stopCluster(cl)
...
case1.SCL.linear.incorrect1correct <- array(0, dim = c(times, 4))
case1.SCL.gaussian.incorrect1correct <- array(0, dim = c(times, 4))
case1.SCL.linear.incorrect2correct <- array(0, dim = c(times, 4))
case1.SCL.gaussian.incorrect2correct <- array(0, dim = c(times, 4))

case1.SCL.linear.correctincorrect <- array(0, dim = c(times, 4))
case1.SCL.gaussian.correctincorrect <- array(0, dim = c(times, 4))

case1.SCL.linear.incorrect1incorrect <- array(0, dim = c(times, 4))
case1.SCL.gaussian.incorrect1incorrect <- array(0, dim = c(times, 4))
case1.SCL.linear.incorrect2incorrect <- array(0, dim = c(times, 4))
case1.SCL.gaussian.incorrect2incorrect <- array(0, dim = c(times, 4))
...
for (j in 1:times) {
  ...
  case1.SCL.linear.incorrect1correct[j, ] <- res[[j]]$SCL.linear.incorrect1correct
  case1.SCL.gaussian.incorrect1correct[j, ] <- res[[j]]$SCL.gaussian.incorrect1correct
  case1.SCL.linear.incorrect2correct[j, ] <- res[[j]]$SCL.linear.incorrect2correct
  case1.SCL.gaussian.incorrect2correct[j, ] <- res[[j]]$SCL.gaussian.incorrect2correct
  ...
  case1.SCL.linear.incorrect1incorrect[j, ] <- res[[j]]$SCL.linear.incorrect1incorrect
  case1.SCL.gaussian.incorrect1incorrect[j, ] <- res[[j]]$SCL.gaussian.incorrect1incorrect
  case1.SCL.linear.incorrect2incorrect[j, ] <- res[[j]]$SCL.linear.incorrect2incorrect
  case1.SCL.gaussian.incorrect2incorrect[j, ] <- res[[j]]$SCL.gaussian.incorrect2incorrect
}